...
public class PhotonTranform : MonoBehaviourPun, IPunObservable
{   
    public static PhotonTranform instance;
    ...
    public void ShootEvent(bool eventShoot)
    {
        Shooting = eventShoot;
    }
    public void Update()
    {
        ...
        if (!this.photonView.IsMine && Shooting == true)
        {
            if (m_UseLocal)
